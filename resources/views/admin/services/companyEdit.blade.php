        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="container-fluid bg-light">
                <div class="container mt-5" >
                    <a href="{{ url('/companies') }}" class="btn btn-primary btn-sm outlined mb-3">Back to usefull Companies</a>
                    <h1 class="title">Editing {{ $company->name }} </h1>
                        ...
                        <form action="{{ url('/updateCompany', $company->id) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row ">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" id="projectinput1" class="form-control"  value="{{ $company-> contact}}" name="contact">
                            </div>
                            <div class="col-4">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" rows="5" name="activities" id="activities">{{ $company->activities}}</textarea>
                                      </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mt-4">
                                        ...
                                        <img src="{{ asset('storage/images/companies/').$company->image }}" width="120px">
                                    </div>
                                </div>
