          ...
          <form action="{{url('/contactus')}}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group form-group-icon">
                    ...
                    <input type="text" class="form-control border-primary" name="fname" placeholder="Your Names" required>
                </div>
                <div class="form-group form-group-icon">
                    <i class="fas fa-envelope" aria-hidden="true"></i>
                    <input type="email" class="form-control border-success" name="email" placeholder="Your Email address"
                           required>
                </div>
                <div class="form-group form-group-icon">
