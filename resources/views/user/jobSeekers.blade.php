...
-->
  ...
  <body>
    ...
    <section class="breadcrumb-bg mt-10" style="background-image: url(assets/images/cars.jpg);">
        <div class="container">
          <div class="breadcrumb-holder">
            <div>
              <h1 class="breadcrumb-title">Job Seekers</h1>
    ...
    <div class="container">
        <h2>List of Recent Job Seekers</h2>
        ...
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ $i }}</td>
              <td> <img class="card-img-top lazyestload" src="{{ asset('storage/images/employees/'.$serv->image) }}"
                alt="{{ $serv->names }}" style="width: 120px;"></td>
              <td>{{ $serv->names }}</td>
              <td>{{ $serv->phone }}</td>
              <td>{{ $serv->career }}</td>
              <td>{{ $serv->cv}}</td>
