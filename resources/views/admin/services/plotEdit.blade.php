            ...
            <div class="container-fluid mt-5 bg-light">
                <div class="container" >
                    ...
                    <div class="col-12">
                        ...
                        <form action="{{ url('PlotSave', $plot->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row ">
                                <div class="form-group mr-5">
                                  ...
                                  <div class="form-group mr-3">
                                    ...
                                    <input type="text" class="form-control" value="{{ $plot->location }}" name="location" id="location">
                                  </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="5" name="details" id="details">{{ $plot->details }}</textarea>
                                </div>

                                    <div class="form-group mr-5">
                                        <label for="contact">Owner's Contact</label>
                                        <input type="text" class="form-control" value="{{ $plot->contact }}" name="contact" id="contact">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-5">
                                    <div class="col-4">
                                        ...
                                        <img src="{{ asset('/storage/images/houses/').$plot->image }}" width="80px">
                                    </div>
                                    <div class="col-4">
